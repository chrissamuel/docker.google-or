...
RUN apt-get update -y && \
    apt-get upgrade -y && \
    apt-get install -y pigz wget bison flex python-setuptools python-dev autoconf \
...
RUN su googleor -c "tar -I pigz -xf or-tools_Ubuntu-16.04-64bit_v4.3.3802.tar.gz"
